...
![RadioCLI Now Playing visualizer demo](/demo/radiocli-now-playing.gif)
...
pulse-grid style is fast and direct, while the retained alternates include the
restored spinning ASCII cube plus generated ASCII fire, fireworks, plasma,
...
contribution graph shows the last 53 weeks (371 days) of local listening activity, while
