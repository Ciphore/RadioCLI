...
<video controls autoPlay muted loop playsInline preload="metadata" poster="/demo/radiocli-fullscreen.png" aria-label="Now Playing cycling receiver visualizers and display colors">
...
![Nearby stations using approximate location lookup](/demo/radiocli-nearby.gif)
