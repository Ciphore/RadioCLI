...
- Reduced the ASCII cube receiver footprint so the spinning cube stays centered
  inside the Now Playing visualizer area instead of crowding or clipping against
  nearby receiver content.
